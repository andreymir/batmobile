...
public class ShieldBotUtility {
    ...
    public static ControlSignal CreateControlSignalFromVector(float pitch, float roll){
        ...
        if (pitch > RotationController.AVG_PITCH_VALUE){
            ...
            current_max_spin_value = (pitch - RotationController.AVG_PITCH_VALUE) * ShieldBot.MAX_REVERS_SPIN_VALUE / (RotationController.MIN_PITCH_VALUE - RotationController.AVG_PITCH_VALUE);
        }
